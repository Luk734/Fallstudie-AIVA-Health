// src/pages/modules/care/AppointmentDetailPage.jsx — Termin-Detail (US-14, TASK-54)
//
// Zeigt alle Details eines einzelnen Arzttermins an.
// Der User erreicht diese Seite durch Klick auf eine AppointmentCard
// in der Termin-Liste (/care). Die Termin-ID kommt aus der URL.
//
// Layout:
//   ← Zurück-Button
//   PageHeader mit Titel + Status-Badge
...
//   PageContainer, PageHeader, Card, Badge, Button, Alert, Spinner
...
import '../../../styles/pages/modules/care/AppointmentDetailPage.css';
